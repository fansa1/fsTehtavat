...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.notificationChange(content)
  }
...
const Menu = () => {
  ...
  return (
    <div>
      ...
      <Notification/>   
      <Route path exact path="/" render={() => <AnecdoteList anecdotes={anecdotes}/>} />
    </div>
  )
}
  ...
  return (
      ...
      <ShowAnecdote anecdote={anecdoteById(match.params.id)} />} />
      <Route path="/about" render={() => <About />} />
      <Route path="/create" render={() => notification==='' ? <CreateNew addNew={addNew} notificationChange={notificationChange} /> : <Redirect to="/" />} />
